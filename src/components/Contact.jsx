...
const Contact = () => {
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
      <form  method='POST' action="https://getform.io/f/zaxmdlpb" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'> 
        ...
        <textarea className='bg-[#ccd6f6] p-2' id="" name='message' placeholder='Message' rows="10"></textarea>
